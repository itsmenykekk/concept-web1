            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {budgetItems.map((row, i) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-muted-foreground text-xs leading-relaxed hidden sm:table-cell max-w-xs">
                      {row.desc}
                    </td>
                    <td className="px-6 py-4 text-right text-primary font-semibold whitespace-nowrap">
                      {row.cost}
                    </td>
                  </tr>
                ))}
              ...
              <tfoot>
                <tr className="bg-primary/10">
                  <td colSpan={2} className="px-6 py-4 font-display font-bold text-foreground text-right">
                    Total
                  </td>
                  <td className="px-6 py-4 text-right font-display font-bold text-primary text-base">
                    {totalCost}
                  </td>
                </tr>
              </tfoot>
