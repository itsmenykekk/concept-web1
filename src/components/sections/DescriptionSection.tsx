        ...
        <div className="max-w-2xl mx-auto glass rounded-2xl p-12 text-center glow-pink-sm relative overflow-hidden">
          ...
          <div className="relative flex flex-col items-center gap-3">
            ...
            <p className="text-muted-foreground italic text-sm">
              This project is a mobile app aimed at improving financial literacy among young people and small business owners in the Philippines. Despite increased access to financial services, many individuals struggle with managing money, leading to debt, poor investments, and business challenges.
              The mobile app provides simple, easy-to-understand information on key financial topics such as budgeting, saving, investing, responsible borrowing, tax compliance, and cash flow management. It highlights both the benefits of good financial habits and the risks of poor financial knowledge, showing how these affect personal stability, career growth, and business success.
              In addition to educational content, the app offers practical tools and activities, including creating personal budgets, developing business financial plans, exploring investment options, joining workshops, and practicing bookkeeping. These features encourage users to apply what they learn.
